  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <?php
        ...
        $offset = ($page - 1) * $limit;
        $count=$offset+1;
        $sql= "select * from donor_details join doctor where donor_details.donor_doctor=doctor.doctor_id ";
      ...
      <table class="table table-bordered" style="text-align:center">
          ...
          <th style="text-align:center">Donor_id</th>
          ...
          <tr>
                  ...
                  <td><?php echo $row['donor_gender']; ?></td>
                    ...
                    <td><?php echo $row['donor_weight']; ?></td>
                    <td><?php echo $row['doctor_name']; ?></td>
                    <td id="he" style="width:100px">
                    <a style="background-color:aqua" href='editdonor.php?id=<?php echo $row['donor_id']; ?>'> Edit </a>

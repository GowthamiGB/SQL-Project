                ...
                <div class="panel-body panel-info bk-primary text-light" style="background-color:#D6EAF8; border-radius:50px">
                  <div class="stat-panel text-center">
                    ...
                    ?>
                      ...
                      <div class="stat-panel-number h2"><?php echo $row?></div>
                    <div class="stat-panel-title text-uppercase"> Request for Blood </div>
                    <br>
                      <button class="btn btn-danger" onclick="window.location.href = 'patient_list.php';">
                        Full Detail <i class="fa fa-arrow-right"></i>
                      </button>

...
<h2><a style=" color:white;text-decoration:none;" href="../home.php" class="logo">Blood Bank Management</a></h2>
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      <div class="row justify-content-center">
          <div class="col-lg-6">
              <h1 class="mt-4 mb-3" style="height:60px;background-color:black;border-radius:2px;color:white ;text-align:center;">
                  Admin Login Portal
                </h1>
      ...
      <div class="font-italic" style="font-size:20px;font-weight:bold">Username<span style="color:red">*</span></div>
    ...
    <div class="font-italic"style="font-size:20px;font-weight:bold">Password<span style="color:red">*</span></div>
